        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DataPlanId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NationalData = table.Column<float>(nullable: false),
                    InternationalData = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataPlanId = table.Column<int>(nullable: false),
                    NationalDataUsage = table.Column<float>(nullable: false),
                    InternationalDataUsage = table.Column<float>(nullable: false),
                    MobilePhoneIMEI = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
